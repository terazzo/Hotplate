...
public class SimpleDefineProcessor extends AbstractSimpleTemplate implements SimpleTemplate {
    ...
    public SimpleDefineProcessor(
            Context<Object, SimpleTemplate> lexicalContext, Symbol symbol, SimpleSource source) {        super();
    ...
    public TemplatePair<Object, SimpleTemplate> apply(Context<Object, SimpleTemplate> context) {
        ...
        Associable<Object, SimpleTemplate> definition = source.getAssociable(totalContext);
        if (definition == null) {
